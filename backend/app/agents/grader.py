...
With no cross-encoder reranker in V1, the grader is the precision layer.
Its prompt does two distinct jobs: per-chunk relevance (is this passage
...
async def grade_chunks(
    ...
    """Grade each chunk for relevance and the set for sufficiency."""
